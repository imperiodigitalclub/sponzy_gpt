...
class HomeController extends Controller
{
  ...
  public function __construct(Request $request, AdminSettings $settings)
  {
    ...
    try {
      ...
      \Log::error('Erro no método construtor HomeController__construct:');
  ...
  public function index()
  {
    try {
      ...
      \Log::error('Erro no método HomeController.index():');
      \Log::error($e->getMessage());
  ...
  public function indexExplore()
  {
    ...
    $updates = Updates::verifyCountryBlocking()->where('locked', 'no');
    ...
    // Renderiza a mesma view 'index.explore', omitindo a variável payPerViewsUser
    return view('index.explore', [
      'updates' => $updates,
      'hasPages' => $updates->hasPages(),
      'users' => $users,
      'payPerViewsUser' => null, // Define como null já que auth não é necessário
      'fonts' => $fonts ?? null
    ]);
  }
