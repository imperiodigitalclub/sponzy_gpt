...
/*
 ...
 |-----------------------------------
 */
Route::get('/', [HomeController::class, 'indexExplore'])->name('home');
...
Route::get('verify/account/{confirmation_code}', [HomeController::class, 'getVerifyAccount'])->where('confirmation_code','[A-Za-z0-9]+');
 ...
 Route::group(['middleware' => 'auth'], function() {
	...
	//======================================= MercadoPago ================================//
	Route::get("mp/sub", [MercadoPagoController::class, 'buyPlan'])->name('mp.sub');
	Route::get("mp/cards", [MercadoPagoController::class, 'formAddUpdatePaymentCard']);
	Route::post("mp/generatepix", [MercadoPagoController::class, 'generatePix']);
	Route::post("mp/checkpix", [MercadoPagoController::class, 'checkPixStatus']);
	Route::post("mp/cpaymentplan", [MercadoPagoController::class, 'cardPayPlan']);
