        ...
        <div class="card-footer bg-white border-0 pt-0 rounded-large">
          ...
          @endif
            ...
            @if (!$settings->disable_free_post)
              <button type="button" id="contentLocked" class="btn btn-post btn-tooltip-form e-none @if (auth()->user()->dark_mode == 'off') text-primary @else text-white @endif rounded-pill" data-toggle="tooltip" data-placement="top" title="{{__('users.locked_content')}}">
            ...
            <div class="d-inline-block float-right mt-3 mt-lg-1 position-relative w-100-mobile">
              ...
              <span class="d-inline-block float-right position-relative rounded-pill w-100-mobile">
                ...
                <button type="submit" class="btn btn-sm btn-primary rounded-pill float-right e-none w-100-mobile" data-empty="{{__('general.empty_post')}}" data-error="{{__('general.error')}}" data-msg-error="{{__('general.error_internet_disconnected')}}" id="btnCreateUpdate">
