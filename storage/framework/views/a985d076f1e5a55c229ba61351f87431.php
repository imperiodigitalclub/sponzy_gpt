<?php $__env->startSection('title'); ?> <?php echo e(trans('general.likes'), false); ?> -<?php $__env->stopSection(); ?>
...
<section class="section section-sm">
    <div class="container container-lg-3 pt-lg-5 pt-2">
      <div class="row">
        ...
        <h4 class="font-weight-light"><?php echo e(trans('general.no_likes'), false); ?></h4>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/sensualinfluencers.com/resources/views/users/likes.blade.php ENDPATH**/ ?>