                    ...
                    <tr>
                        <td style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; padding: 35px;">
                            ...
                            <h1 style="margin-top: 0; color: #2F3133; font-size: 19px; font-weight: bold; text-align: left;">
                              <?php echo e(trans('emails.hello'), false); ?> <?php echo e($fullname, false); ?>

                            </h1>

                            <!-- Intro -->
                            <p style="margin-top: 0; color: #74787E; font-size: 16px; line-height: 1.5em;">
                              <?php echo e(trans('emails.withdrawal_msg'), false); ?> <strong><?php echo e($amount, false); ?></strong>
                            </p>

                            <!-- Salutation -->
                            <p style="margin-top: 0; color: #74787E; font-size: 16px; line-height: 1.5em;">
                                <?php echo e(trans('emails.regards'), false); ?><br><?php echo e($title_site, false); ?>
...
<?php /**PATH /www/wwwroot/sensualinfluencers.com/resources/views/emails/withdrawal-processed.blade.php ENDPATH**/ ?>