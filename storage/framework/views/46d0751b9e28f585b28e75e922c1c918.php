	...
	<div class="row">
      ...
      <div class="alert alert-success alert-dismissible fade show" role="alert">
            ...
            <div class="row mb-3">
                ...
                <small class="d-block"><a href="https://merchant.binance.com/en/dashboard/developers/api" target="_blank">https://merchant.binance.com/en/dashboard/developers/api</a></small>
		          </div>
		        </div>

            <div class="row mb-3">
		          <label class="col-sm-2 col-form-label text-lg-end">API Secret Key *</label>
		          <div class="col-sm-10">
                ...
                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label text-lg-end"><?php echo e(__('general.currency'), false); ?> *</label>
                    <div class="col-sm-10">
                      <input value="<?php echo e($data->crypto_currency, false); ?>" placeholder="BTC" name="crypto_currency" type="text" class="form-control">
                    </div>
                  </div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/sensualinfluencers.com/resources/views/admin/binance-settings.blade.php ENDPATH**/ ?>