            ...
            <form id="form-checkout">
                ...
                <div class="form-group mt-3">
                    ...
                    <input type="text" class="form-control mt-2" id="cardholderIdNumber" placeholder="454.545.454-54"
                        value="<?php echo e(auth()->user()->cpf, false); ?>" required>
                </div>
                ...
                <div class="form-group mt-3">
                    ...
                    <input type="email" class="form-control" id="form-mp-email" placeholder="example@email.com"
                        value="<?php echo e(auth()->user()->email, false); ?>" required>
                </div>
                ...
                <input name="expirationMonth" id="expirationMonth" maxlength="2" autocomplete="off" hidden
                    inputmode="numeric">
                <input type="hidden" name="creator_id" value="<?php echo e($creator_id, false); ?>">
                <input type="hidden" name="plan_id" value="<?php echo e($plan_id, false); ?>">
                <input type="hidden" name="price" value="<?php echo e($price, false); ?>">
                <input type="hidden" name="interval" value="<?php echo e($interval, false); ?>">
...
</script><?php /**PATH /www/wwwroot/sensualinfluencers.com/resources/views/checkout/mp_payment.blade.php ENDPATH**/ ?>