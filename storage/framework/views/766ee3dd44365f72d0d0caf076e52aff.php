	...
	<div class="row">
      ...
      <div class="alert alert-success alert-dismissible fade show" role="alert">
            ...
            <div class="row mb-3">
		          ...
		          <div class="col-sm-10">
		            <input value="<?php echo e($data->webhook_secret, false); ?>" name="webhook_secret" type="password" class="form-control">
								<p class="d-block">Webhook URL: <strong><?php echo e(url('webhook/paypal'), false); ?></strong></p>
		          </div>
		        </div>
            ...
            <fieldset class="row mb-3">
              ...
              <div class="col-sm-10">
                <div class="form-check form-switch form-switch-md">
                 <input class="form-check-input" type="checkbox" name="sandbox" <?php if($data->sandbox == 'true'): ?> checked="checked" <?php endif; ?> value="true" role="switch">
               </div>
              </div>
            </fieldset>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/sensualinfluencers.com/resources/views/admin/paypal-settings.blade.php ENDPATH**/ ?>